...
class EndCutscene:
    def __init__(self, surface, on_complete):
        ...
        self.x = self.INTERNAL_WIDTH // 2 - 48  # center horizontally
    ...
    def run(self):
        ...
        while running:
            ...
            if self.y > self.INTERNAL_HEIGHT:  # completely off the bottom
                running = False
                self.on_complete()
                return
            ...
            # Scale internal surface to match display size
